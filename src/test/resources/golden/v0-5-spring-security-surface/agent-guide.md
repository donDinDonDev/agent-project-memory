...
- Bean methods: status `analyzed`; detected 2 source-visible `@Bean` method signals.
  - Bean method: Detected `com.example.security.SecuritySurface#applicationSecurity` with bean_name_status `not_analyzed` (surface_category: `spring_bean_method`, support_type: `extracted`, bean_signal: `direct_bean_method`).
  ...
  - Bean method: Detected `com.example.security.SecuritySurface#managementSecurity` with bean_name_status `not_analyzed` (surface_category: `spring_bean_method`, support_type: `extracted`, bean_signal: `direct_bean_method`).
    - Source: `src/main/java/com/example/security/SecuritySurface.java`
    - Module: Detected `module:.` (path: `.`)
...
- Spring Security configuration warnings: status `analyzed`; referenced 4 inspection hint/change-risk warning IDs `warning:spring_security:security_configuration_annotation:com.example.security.SecuritySurface:annotation:enable_method_security:decl:000002`, `warning:spring_security:security_configuration_annotation:com.example.security.SecuritySurface:annotation:enable_web_security:decl:000001`, `warning:spring_security:security_filter_chain_bean:com.example.security.SecuritySurface#applicationSecurity:decl:000001`, `warning:spring_security:security_filter_chain_bean:com.example.security.SecuritySurface#managementSecurity:decl:000002`.
  - Spring Security warning: Inspection hint `security_configuration_annotation` for module `module:.` (path: `.`) at `src/main/java/com/example/security/SecuritySurface.java`. Spring Security configuration annotation detected as a source-visible inspection hint and change-risk signal; the analyzer does not evaluate security policy, endpoint protection, authentication, authorization, filter-chain order, vulnerability, or correctness.
