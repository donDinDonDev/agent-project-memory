...
3. For Spring wiring changes, inspect detected component evidence in `src/main/java/com/example/mixed/OrderController.java` and avoid assuming runtime injection graphs.
