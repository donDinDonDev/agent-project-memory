...
3. For Spring application surface changes, inspect repository surface and component evidence in `src/main/java/com/example/mixed/OrderController.java` and avoid assuming runtime repository registration, entity ownership, or injection graphs.
