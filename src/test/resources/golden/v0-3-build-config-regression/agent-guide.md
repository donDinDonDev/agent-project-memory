...
3. For Spring application surface changes, inspect repository surface and component evidence in `services/alpha/src/main/java/com/example/alpha/AlphaApplication.java`, `services/zeta/src/main/java/com/example/zeta/ZetaApplication.java` and avoid assuming runtime repository registration, entity ownership, or injection graphs.
